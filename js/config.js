...
const BROADCASTERS = [
  ...
  { id:'abcaustralia', name:'ABC AUSTRALIA', handle:'abcaustralia',  channelId:'UC5iLnYoF4Ryb63YdGD9RfWQ', color:'#FFB000', cover:'OCE',  desc:'Australia · Pacific · live news',     regions:['australia','oceania','pacific','new zealand','sydney','melbourne','canberra','papua new guinea','fiji','tasman','indo-pacific'], cats:['geo','fin','mil'], lat:-33.8688, lng:151.2093, city:'SYDNEY' },
];
